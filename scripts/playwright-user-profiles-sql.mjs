...
const SQL = fs.readFileSync(path.join(process.cwd(), 'supabase', 'sql', 'user-profiles.sql'), 'utf8')
...
try {
  await page.goto('https://supabase.com/dashboard/project/isjxfqkvavoaksroutre/sql/new', { waitUntil: 'domcontentloaded', timeout: 90000 })
  ...
  await page.screenshot({ path: path.join(OUT, 'user-profiles-sql.png') })
  console.log('SQL_OK')
} catch (error) {
